// This is the t1ha_0 hash function implemented in https://github.com/leo-yuriev/t1ha
// As realized in Go by https://github.com/dgryski/go-t1ha
// This is modified simply to follow Hash64 interface
...
func (d *digest64) Sum64() uint64 {
	...
	if len(d.d) > 32 {
		c := rot64(uint64(len(data)), s1) + d.seed
		d := uint64(len(data)) ^ rot64(d.seed, s1)
